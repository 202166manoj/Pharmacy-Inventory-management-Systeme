...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <button class="back-btn" onclick="window.location.href='casier_dashboard.php';"><i class="fa fa-arrow-left"></i> Back to Dashboard</button>
            ...
            <div class="row">
                ...
                <div class="col col-md-12">
                    <hr class="col-md-12" style="padding: 0px; border-top: 3px solid  #28a745;">
                </div>
                ...
                <div class="col col-md-12">
                    <hr class="col-md-12" style="padding: 0px; border-top: 2px solid    #28a745;">
                </div>
