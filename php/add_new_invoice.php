<?php
  ...
  function addSale() {
    ...
    require "db_connection.php";
    if($conn) {
      $query = "INSERT INTO sales (CUSTOMER_ID, INVOICE_ID, MEDICINE_NAME,  QUANTITY, MRP, DISCOUNT, TOTAL) VALUES($customer_id, $invoice_id, $medicine_name,  $quantity, $mrp, $discount, $total)";
      $result = mysqli_query($conn, $query);
